...
func (x *RegisterReq) fastReadField3(buf []byte, _type int8) (offset int, err error) {
	x.PasswordConform, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}
...
func (x *RegisterReq) fastWriteField3(buf []byte) (offset int) {
	if x.PasswordConform == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 3, x.GetPasswordConform())
	return offset
}
...
func (x *RegisterReq) sizeField3() (n int) {
	...
	n += fastpb.SizeString(3, x.GetPasswordConform())
	return n
}
